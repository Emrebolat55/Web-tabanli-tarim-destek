...
if (isset($_POST["kaydet"])) {
    ...
    if (isset($username) && isset($email) && isset($password) && empty($username_err) && empty($email_err) && empty($parola_err) && empty($parolatkr_err)) {
        ...
        $existingUserResult = mysqli_query($baglanti, $existingUserQuery);
        ...
        if ($existingUserResult) {
            if (mysqli_num_rows($existingUserResult) > 0) {
                ...
                if ($calistirekle) {
                    ...
                    $adminEkle = "UPDATE kullanicilar SET kullanici_tipi = 'admin' WHERE kullanici_adi = '$username'";
                    $calistirUyeEkle = mysqli_query($baglanti, $adminEkle);
                    ...
                    if ($calistirUyeEkle) {
                        ...
                        echo '<div class="alert alert-danger" role="alert">
                            Kullanıcı tipi eklenirken bir hata oluştu: ' . mysqli_error($baglanti) . '
                        </div>';
                    }
                } else {
                    echo '<div class="alert alert-danger" role="alert">
            ...
            echo '<div class="alert alert-danger" role="alert">
                Veritabanı hatası: ' . mysqli_error($baglanti) . '
            </div>';
        }
...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link rel="stylesheet" href="admin kayıt.css">
